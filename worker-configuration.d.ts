/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 14a0bddf0308cb3e9794dfe6e07bf293)
// Runtime types generated with workerd@1.20250924.0 2024-09-23 nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('./src/worker');
    durableNamespaces: 'SessionDurableObject' | 'RealtimeDurableObject' | 'ReactionsDurableObject';
  }
  interface Env {
    WEBAUTHN_APP_NAME: 'redwoodsdk-v1-demo';
    ...
    REACTIONS_DURABLE_OBJECT: DurableObjectNamespace<import('./src/worker').ReactionsDurableObject>;
    my_project_db: D1Database;
    DB: D1Database;
    ASSETS: Fetcher;
  }
}
